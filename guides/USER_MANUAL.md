...
18. [Toolbar Reference](#toolbar-reference)
19. [Context Menus](#context-menus)
...
- **Rename** - click a lane label to edit it
- **Recolor** - set per-lane background color
- **Resize** - drag lane borders to adjust size
...
The toolbar runs along the top of the application, organized into groups:
